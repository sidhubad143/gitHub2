...
def push_folder_to_github(src_dir: str, token: str, repo_url: str, branch: str = "main") -> str:
    """
    Push ALL files from src_dir directly into the GitHub repo (unzipped).
    This is what 'ZIP→GitHub' does — files go into repo, not as a release asset.
    """
    return git_push(src_dir, token, repo_url, branch)
