...
def main_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton("🔀 Rename Path",   callback_data="cmd_rename_path"),
            InlineKeyboardButton("📦 Make ZIP",      callback_data="cmd_zip"),
        ],
        [
            InlineKeyboardButton("📤 Upload ZIP",    callback_data="cmd_github_upload"),
            InlineKeyboardButton("🚀 Git Push",      callback_data="cmd_git_push"),
        ],
        [
            InlineKeyboardButton("📥 Clone",         callback_data="cmd_clone"),
            InlineKeyboardButton("⬇️ Git Pull",      callback_data="cmd_git_pull_btn"),
        ],
        [
...
def repo_edit_keyboard(idx: int) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🗑 Remove from Bot List", callback_data=f"repo_del:{idx}")],
...
def gh_repo_action_kb(repo_full_name: str, is_private: bool, page: int = 0) -> InlineKeyboardMarkup:
    """Action keyboard for a single GitHub repo."""
    import urllib.parse
    safe = urllib.parse.quote(repo_full_name, safe="")
    ...
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("💥 Delete Repo",  callback_data=f"gh_del_name:{safe}")],
